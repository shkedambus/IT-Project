...
class TestMyFunctions(unittest.TestCase):
    ...
    def test_connect_jira_with_valid_credentials(self): #подключение к Jira с действительными данными
    ...
    def test_connect_jira_with_invalid_api_token(self): #подключение к Jira с недействительным API токеном
        user_email = "donskoydmv@gmail.com"
        domain = "mmrfarm"
    ...
    def test_connect_jira_with_invalid_domain(self): #подключение к Jira с недействительным доменом
        user_email = "donskoydmv@gmail.com"
        domain = "1234567890"
        api_token = "VNV84T2cHYKtyJS4xu6RC292"
        result = my_functions.check_connection(domain=domain, api_token=api_token, user_email=user_email)
    ...
    def test_connect_jira_with_invalid_email(self): #подключение к Jira с недействительной электронной почтой
